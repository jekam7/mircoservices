...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'enqueue.client.config' => 'getEnqueue_Client_ConfigService',
            'enqueue.client.consume_messages_command' => 'getEnqueue_Client_ConsumeMessagesCommandService',
            'enqueue.client.meta.queue_meta_registry' => 'getEnqueue_Client_Meta_QueueMetaRegistryService',
            'enqueue.client.meta.queues_command' => 'getEnqueue_Client_Meta_QueuesCommandService',
            'enqueue.client.meta.topic_meta_registry' => 'getEnqueue_Client_Meta_TopicMetaRegistryService',
            'enqueue.client.meta.topics_command' => 'getEnqueue_Client_Meta_TopicsCommandService',
            'enqueue.client.produce_message_command' => 'getEnqueue_Client_ProduceMessageCommandService',
            'enqueue.client.producer' => 'getEnqueue_Client_ProducerService',
            'enqueue.client.producer_v2' => 'getEnqueue_Client_ProducerV2Service',
            'enqueue.client.rabbitmq_amqp.driver' => 'getEnqueue_Client_RabbitmqAmqp_DriverService',
            'enqueue.client.router_processor' => 'getEnqueue_Client_RouterProcessorService',
            'enqueue.client.rpc_client' => 'getEnqueue_Client_RpcClientService',
            'enqueue.client.setup_broker_command' => 'getEnqueue_Client_SetupBrokerCommandService',
            'enqueue.client.spool_producer' => 'getEnqueue_Client_SpoolProducerService',
            'enqueue.command.consume_messages' => 'getEnqueue_Command_ConsumeMessagesService',
            'enqueue.consumption.extensions' => 'getEnqueue_Consumption_ExtensionsService',
            'enqueue.consumption.queue_consumer' => 'getEnqueue_Consumption_QueueConsumerService',
            'enqueue.events.async_listener' => 'getEnqueue_Events_AsyncListenerService',
            'enqueue.events.async_processor' => 'getEnqueue_Events_AsyncProcessorService',
            'enqueue.events.event_dispatcher' => 'getEnqueue_Events_EventDispatcherService',
            'enqueue.events.php_serializer_event_transofrmer' => 'getEnqueue_Events_PhpSerializerEventTransofrmerService',
            'enqueue.events.registry' => 'getEnqueue_Events_RegistryService',
            'enqueue.flush_spool_producer_listener' => 'getEnqueue_FlushSpoolProducerListenerService',
            'enqueue.transport.rabbitmq_amqp.connection_factory' => 'getEnqueue_Transport_RabbitmqAmqp_ConnectionFactoryService',
            'enqueue.transport.rabbitmq_amqp.context' => 'getEnqueue_Transport_RabbitmqAmqp_ContextService',
            'enqueue.transport.rpc_client' => 'getEnqueue_Transport_RpcClientService',
            ...
            'gremo_buzz' => 'getGremoBuzzService',
        ...
        $this->aliases = array(
            'console.command.enqueue_symfony_client_consumemessagescommand' => 'enqueue.client.consume_messages_command',
            'console.command.enqueue_symfony_client_meta_queuescommand' => 'enqueue.client.meta.queues_command',
            'console.command.enqueue_symfony_client_meta_topicscommand' => 'enqueue.client.meta.topics_command',
            'console.command.enqueue_symfony_client_producemessagecommand' => 'enqueue.client.produce_message_command',
            'console.command.enqueue_symfony_client_setupbrokercommand' => 'enqueue.client.setup_broker_command',
            'console.command.enqueue_symfony_consumption_containerawareconsumemessagescommand' => 'enqueue.command.consume_messages',
            ...
            'enqueue.client.default.driver' => 'enqueue.client.rabbitmq_amqp.driver',
            'enqueue.client.driver' => 'enqueue.client.rabbitmq_amqp.driver',
            'enqueue.producer' => 'enqueue.client.producer',
            'enqueue.spool_producer' => 'enqueue.client.spool_producer',
            'enqueue.transport.connection_factory' => 'enqueue.transport.rabbitmq_amqp.connection_factory',
            'enqueue.transport.context' => 'enqueue.transport.rabbitmq_amqp.context',
            'enqueue.transport.default.connection_factory' => 'enqueue.transport.rabbitmq_amqp.connection_factory',
            'enqueue.transport.default.context' => 'enqueue.transport.rabbitmq_amqp.context',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('enqueue.flush_spool_producer_listener', 'Enqueue\\Symfony\\Client\\FlushSpoolProducerListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mysql_product', 'port' => NULL, 'dbname' => 'product', 'user' => 'product', 'password' => 'kW6B4IUgs', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_69105aab7fd7f7497d671d580b5fbe56e2b9fd964f1c5165716c883c61ce4538');
    ...
    /**
     * Gets the 'enqueue.client.consume_messages_command' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Client\ConsumeMessagesCommand A Enqueue\Symfony\Client\ConsumeMessagesCommand instance
     */
    protected function getEnqueue_Client_ConsumeMessagesCommandService()
    {
        $a = new \Enqueue\Symfony\Client\ContainerAwareProcessorRegistry(array('enqueue.client.router_processor' => 'enqueue.client.router_processor'));
        $a->setContainer($this);

        return $this->services['enqueue.client.consume_messages_command'] = new \Enqueue\Symfony\Client\ConsumeMessagesCommand(new \Enqueue\Consumption\QueueConsumer($this->get('enqueue.transport.rabbitmq_amqp.context'), $this->get('enqueue.consumption.extensions')), new \Enqueue\Client\DelegateProcessor($a), $this->get('enqueue.client.meta.queue_meta_registry'), $this->get('enqueue.client.rabbitmq_amqp.driver'));
    }

    /**
     * Gets the 'enqueue.client.meta.queue_meta_registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\Meta\QueueMetaRegistry A Enqueue\Client\Meta\QueueMetaRegistry instance
     */
    protected function getEnqueue_Client_Meta_QueueMetaRegistryService()
    {
        return $this->services['enqueue.client.meta.queue_meta_registry'] = new \Enqueue\Client\Meta\QueueMetaRegistry($this->get('enqueue.client.config'), array('default' => array('processors' => array(0 => 'enqueue.client.router_processor'))));
    }

    /**
     * Gets the 'enqueue.client.meta.queues_command' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Client\Meta\QueuesCommand A Enqueue\Symfony\Client\Meta\QueuesCommand instance
     */
    protected function getEnqueue_Client_Meta_QueuesCommandService()
    {
        return $this->services['enqueue.client.meta.queues_command'] = new \Enqueue\Symfony\Client\Meta\QueuesCommand($this->get('enqueue.client.meta.queue_meta_registry'));
    }

    /**
     * Gets the 'enqueue.client.meta.topic_meta_registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\Meta\TopicMetaRegistry A Enqueue\Client\Meta\TopicMetaRegistry instance
     */
    protected function getEnqueue_Client_Meta_TopicMetaRegistryService()
    {
        return $this->services['enqueue.client.meta.topic_meta_registry'] = new \Enqueue\Client\Meta\TopicMetaRegistry(array('__router__' => array('processors' => array(0 => 'enqueue.client.router_processor'))));
    }

    /**
     * Gets the 'enqueue.client.meta.topics_command' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Client\Meta\TopicsCommand A Enqueue\Symfony\Client\Meta\TopicsCommand instance
     */
    protected function getEnqueue_Client_Meta_TopicsCommandService()
    {
        return $this->services['enqueue.client.meta.topics_command'] = new \Enqueue\Symfony\Client\Meta\TopicsCommand($this->get('enqueue.client.meta.topic_meta_registry'));
    }

    /**
     * Gets the 'enqueue.client.produce_message_command' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Client\ProduceMessageCommand A Enqueue\Symfony\Client\ProduceMessageCommand instance
     */
    protected function getEnqueue_Client_ProduceMessageCommandService()
    {
        return $this->services['enqueue.client.produce_message_command'] = new \Enqueue\Symfony\Client\ProduceMessageCommand($this->get('enqueue.client.producer'));
    }

    /**
     * Gets the 'enqueue.client.producer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\Producer A Enqueue\Client\Producer instance
     */
    protected function getEnqueue_Client_ProducerService()
    {
        return $this->services['enqueue.client.producer'] = new \Enqueue\Client\Producer($this->get('enqueue.client.rabbitmq_amqp.driver'), new \Enqueue\Client\ChainExtension(array()));
    }

    /**
     * Gets the 'enqueue.client.producer_v2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\ProducerV2 A Enqueue\Client\ProducerV2 instance
     */
    protected function getEnqueue_Client_ProducerV2Service()
    {
        return $this->services['enqueue.client.producer_v2'] = new \Enqueue\Client\ProducerV2($this->get('enqueue.client.producer'), $this->get('enqueue.client.rpc_client'));
    }

    /**
     * Gets the 'enqueue.client.rabbitmq_amqp.driver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\AmqpExt\Client\RabbitMqDriver A Enqueue\AmqpExt\Client\RabbitMqDriver instance
     */
    protected function getEnqueue_Client_RabbitmqAmqp_DriverService()
    {
        return $this->services['enqueue.client.rabbitmq_amqp.driver'] = new \Enqueue\AmqpExt\Client\RabbitMqDriver($this->get('enqueue.transport.rabbitmq_amqp.context'), $this->get('enqueue.client.config'), $this->get('enqueue.client.meta.queue_meta_registry'));
    }

    /**
     * Gets the 'enqueue.client.router_processor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\RouterProcessor A Enqueue\Client\RouterProcessor instance
     */
    protected function getEnqueue_Client_RouterProcessorService()
    {
        return $this->services['enqueue.client.router_processor'] = new \Enqueue\Client\RouterProcessor($this->get('enqueue.client.rabbitmq_amqp.driver'), array('__router__' => array(0 => array(0 => 'enqueue.client.router_processor', 1 => 'default'))));
    }

    /**
     * Gets the 'enqueue.client.rpc_client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\RpcClient A Enqueue\Client\RpcClient instance
     */
    protected function getEnqueue_Client_RpcClientService()
    {
        return $this->services['enqueue.client.rpc_client'] = new \Enqueue\Client\RpcClient($this->get('enqueue.client.producer'), $this->get('enqueue.transport.rabbitmq_amqp.context'));
    }

    /**
     * Gets the 'enqueue.client.setup_broker_command' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Client\SetupBrokerCommand A Enqueue\Symfony\Client\SetupBrokerCommand instance
     */
    protected function getEnqueue_Client_SetupBrokerCommandService()
    {
        return $this->services['enqueue.client.setup_broker_command'] = new \Enqueue\Symfony\Client\SetupBrokerCommand($this->get('enqueue.client.rabbitmq_amqp.driver'));
    }

    /**
     * Gets the 'enqueue.client.spool_producer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Client\SpoolProducer A Enqueue\Client\SpoolProducer instance
     */
    protected function getEnqueue_Client_SpoolProducerService()
    {
        return $this->services['enqueue.client.spool_producer'] = new \Enqueue\Client\SpoolProducer($this->get('enqueue.client.producer'));
    }

    /**
     * Gets the 'enqueue.command.consume_messages' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Consumption\ContainerAwareConsumeMessagesCommand A Enqueue\Symfony\Consumption\ContainerAwareConsumeMessagesCommand instance
     */
    protected function getEnqueue_Command_ConsumeMessagesService()
    {
        return $this->services['enqueue.command.consume_messages'] = new \Enqueue\Symfony\Consumption\ContainerAwareConsumeMessagesCommand($this->get('enqueue.consumption.queue_consumer'));
    }

    /**
     * Gets the 'enqueue.consumption.queue_consumer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Consumption\QueueConsumer A Enqueue\Consumption\QueueConsumer instance
     */
    protected function getEnqueue_Consumption_QueueConsumerService()
    {
        return $this->services['enqueue.consumption.queue_consumer'] = new \Enqueue\Consumption\QueueConsumer($this->get('enqueue.transport.rabbitmq_amqp.context'), $this->get('enqueue.consumption.extensions'));
    }

    /**
     * Gets the 'enqueue.events.async_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Bundle\Events\AsyncListener A Enqueue\Bundle\Events\AsyncListener instance
     */
    protected function getEnqueue_Events_AsyncListenerService()
    {
        return $this->services['enqueue.events.async_listener'] = new \Enqueue\Bundle\Events\AsyncListener($this->get('enqueue.client.producer'), $this->get('enqueue.events.registry'));
    }

    /**
     * Gets the 'enqueue.events.async_processor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Bundle\Events\AsyncProcessor A Enqueue\Bundle\Events\AsyncProcessor instance
     */
    protected function getEnqueue_Events_AsyncProcessorService()
    {
        return $this->services['enqueue.events.async_processor'] = new \Enqueue\Bundle\Events\AsyncProcessor($this->get('enqueue.events.registry'), $this->get('enqueue.events.event_dispatcher'));
    }

    /**
     * Gets the 'enqueue.events.event_dispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Bundle\Events\ProxyEventDispatcher A Enqueue\Bundle\Events\ProxyEventDispatcher instance
     */
    protected function getEnqueue_Events_EventDispatcherService()
    {
        return $this->services['enqueue.events.event_dispatcher'] = new \Enqueue\Bundle\Events\ProxyEventDispatcher($this, $this->get('debug.event_dispatcher'), $this->get('enqueue.events.async_listener'));
    }

    /**
     * Gets the 'enqueue.events.php_serializer_event_transofrmer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Bundle\Events\PhpSerializerEventTransformer A Enqueue\Bundle\Events\PhpSerializerEventTransformer instance
     */
    protected function getEnqueue_Events_PhpSerializerEventTransofrmerService()
    {
        return $this->services['enqueue.events.php_serializer_event_transofrmer'] = new \Enqueue\Bundle\Events\PhpSerializerEventTransformer();
    }

    /**
     * Gets the 'enqueue.flush_spool_producer_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Symfony\Client\FlushSpoolProducerListener A Enqueue\Symfony\Client\FlushSpoolProducerListener instance
     */
    protected function getEnqueue_FlushSpoolProducerListenerService()
    {
        return $this->services['enqueue.flush_spool_producer_listener'] = new \Enqueue\Symfony\Client\FlushSpoolProducerListener($this->get('enqueue.client.spool_producer'));
    }

    /**
     * Gets the 'enqueue.transport.rabbitmq_amqp.connection_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\AmqpExt\AmqpConnectionFactory A Enqueue\AmqpExt\AmqpConnectionFactory instance
     */
    protected function getEnqueue_Transport_RabbitmqAmqp_ConnectionFactoryService()
    {
        return $this->services['enqueue.transport.rabbitmq_amqp.connection_factory'] = new \Enqueue\AmqpExt\AmqpConnectionFactory(array('host' => 'message_bus', 'delay_plugin_installed' => false, 'port' => 5672, 'user' => 'guest', 'pass' => 'guest', 'vhost' => '/', 'persisted' => false, 'lazy' => true));
    }

    /**
     * Gets the 'enqueue.transport.rabbitmq_amqp.context' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\AmqpExt\AmqpContext A Enqueue\AmqpExt\AmqpContext instance
     */
    protected function getEnqueue_Transport_RabbitmqAmqp_ContextService()
    {
        return $this->services['enqueue.transport.rabbitmq_amqp.context'] = $this->get('enqueue.transport.rabbitmq_amqp.connection_factory')->createContext();
    }

    /**
     * Gets the 'enqueue.transport.rpc_client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Enqueue\Rpc\RpcClient A Enqueue\Rpc\RpcClient instance
     */
    protected function getEnqueue_Transport_RpcClientService()
    {
        return $this->services['enqueue.transport.rpc_client'] = new \Enqueue\Rpc\RpcClient($this->get('enqueue.transport.rabbitmq_amqp.context'));
    }
     ...
     */
    protected function getGremoBuzzService()
    {
        return $this->services['gremo_buzz'] = new \Buzz\Browser(new \Buzz\Client\FileGetContents());
    }
    ...
    protected function getProfilerService()
    {
        ...
        $instance->add(new \Enqueue\Bundle\Profiler\MessageQueueCollector($this->get('enqueue.client.producer')));
        $instance->add($d);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/enqueue/enqueue-bundle/Resources/views'), 'Enqueue');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f02bc4a0dd472b36311ab63d329582994bbfaea0');
    }
    ...
    /**
     * Gets the 'enqueue.client.config' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \Enqueue\Client\Config A Enqueue\Client\Config instance
     */
    protected function getEnqueue_Client_ConfigService()
    {
        return $this->services['enqueue.client.config'] = new \Enqueue\Client\Config('enqueue', 'app', 'router', 'default', 'default', 'enqueue.client.router_processor', array('host' => 'message_bus', 'delay_plugin_installed' => false, 'port' => 5672, 'user' => 'guest', 'pass' => 'guest', 'vhost' => '/', 'persisted' => false, 'lazy' => true));
    }

    /**
     * Gets the 'enqueue.consumption.extensions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \Enqueue\Consumption\ChainExtension A Enqueue\Consumption\ChainExtension instance
     */
    protected function getEnqueue_Consumption_ExtensionsService()
    {
        return $this->services['enqueue.consumption.extensions'] = new \Enqueue\Consumption\ChainExtension(array(0 => new \Enqueue\Client\ConsumptionExtension\SetRouterPropertiesExtension($this->get('enqueue.client.rabbitmq_amqp.driver')), 1 => new \Enqueue\Consumption\Extension\ReplyExtension(), 2 => new \Enqueue\Client\ConsumptionExtension\FlushSpoolProducerExtension($this->get('enqueue.client.spool_producer'))));
    }

    /**
     * Gets the 'enqueue.events.registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \Enqueue\Bundle\Events\ContainerAwareRegistry A Enqueue\Bundle\Events\ContainerAwareRegistry instance
     */
    protected function getEnqueue_Events_RegistryService()
    {
        $this->services['enqueue.events.registry'] = $instance = new \Enqueue\Bundle\Events\ContainerAwareRegistry(array('/.*/' => 'php_serializer'), array('php_serializer' => 'enqueue.events.php_serializer_event_transofrmer'));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59422c2c0c3310.53899994')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GremoBuzzBundle' => 'Gremo\\BuzzBundle\\GremoBuzzBundle',
            ...
            'kernel.bundles_metadata' => array(
                ...
                'GremoBuzzBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/gremo/buzz-bundle'),
            ...
            'database_host' => 'mysql_product',
            'database_port' => NULL,
            'database_name' => 'product',
            'database_user' => 'product',
            'database_password' => 'kW6B4IUgs',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'f02bc4a0dd472b36311ab63d329582994bbfaea0',
            'host' => 'localhost',
            'user_auth_url' => 'localhost/user/auth/',
            'product_create_url' => 'localhost/product/create/',
            'locale' => 'en',
            ...
            'gremo_buzz.client.curl.class' => 'Buzz\\Client\\Curl',
            'gremo_buzz.client.multi_curl.class' => 'Buzz\\Client\\MultiCurl',
            'gremo_buzz.client.native.class' => 'Buzz\\Client\\FileGetContents',
            'gremo_buzz.class' => 'Buzz\\Browser',
            'gremo_buzz.client.class' => 'Buzz\\Client\\FileGetContents',
            ...
            'kernel.secret' => 'f02bc4a0dd472b36311ab63d329582994bbfaea0',
            ...
            'data_collector.templates' => array(
                ...
                'enqueue.profiler.message_queue_collector' => array(
                    ...
                    1 => 'EnqueueBundle:Profiler:panel.html.twig',
                ),
            ...
            'console.command.ids' => array(
                0 => 'enqueue.command.consume_messages',
                1 => 'enqueue.client.consume_messages_command',
                2 => 'enqueue.client.produce_message_command',
                3 => 'enqueue.client.meta.topics_command',
                4 => 'enqueue.client.meta.queues_command',
                5 => 'enqueue.client.setup_broker_command',
